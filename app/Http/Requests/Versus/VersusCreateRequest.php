...
namespace App\Http\Requests\Versus;
use App\Rules\NonEmptyTitleArray;
use Illuminate\Foundation\Http\FormRequest;

class VersusCreateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'verdict' => ['nullable', 'integer'],
            'verdict2' => ['nullable', 'integer'],
            'reporter' => ['nullable'],
            'region' => ['nullable'],
            'persons' => ['array'],
            'options' => ['array'],
            ...
            'title1' => ['array', new NonEmptyTitleArray],
            'title2' => ['array', new NonEmptyTitleArray],
            'slogan1' => ['array'],
            'slogan2' => ['array'],
            'content' => ['array'],
            'seoTitles' => ['array'],
