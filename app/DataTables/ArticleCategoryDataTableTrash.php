...
class ArticleCategoryDataTableTrash extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('actions', function ($row) {
                $restoreGate      = 'backend.articleCategory.restore';
                $removeGate    = 'backend.articleCategory.remove';
    ...
    {
        return 'Article_CategoriesTrash_'.date('YmdHis');
    }
}
