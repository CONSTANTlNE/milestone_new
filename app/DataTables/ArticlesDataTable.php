...
//            ->cacheFor(now()->addMinutes(10)) // Cache for 10 minutes
//            ->toJson();
        return (new EloquentDataTable($query))
            ...
            ->editColumn('actions', function ($row) {
                $statusGate      = 'backend.articles.status';
                $showGate        = 'backend.articles.show';
                $editGate        = 'backend.articles.edit';
                $destroyGate     = 'backend.articles.destroy';
