...
class DatasDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('actions', function ($row) {
                $statusGate    = 'backend.data.status';
                $showGate      = 'backend.data.show';
                $editGate      = 'backend.data.edit';
                $destroyGate   = 'backend.data.destroy';
