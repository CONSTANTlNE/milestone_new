...
class PermissionsDataTableTrash extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('actions', function ($row) {
                $restoreGate      = 'backend.permissions.restore';
                $removeGate    = 'backend.permissions.remove';
    ...
    {
        return 'PermissionsTrash_'.date('YmdHis');
    }
}
