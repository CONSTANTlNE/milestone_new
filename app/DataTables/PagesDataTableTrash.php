...
class PagesDataTableTrash extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('actions', function ($row) {
                $restoreGate      = 'backend.pages.restore';
                $removeGate    = 'backend.pages.remove';
    ...
    {
        return 'PagesTrash_'.date('YmdHis');
    }
}
