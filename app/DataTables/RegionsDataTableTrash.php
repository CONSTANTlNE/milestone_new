...
class RegionsDataTableTrash extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('actions', function ($row) {
                $restoreGate      = 'backend.regions.restore';
                $removeGate    = 'backend.regions.remove';
    ...
    {
        return 'RegionsTrash_'.date('YmdHis');
    }
}
