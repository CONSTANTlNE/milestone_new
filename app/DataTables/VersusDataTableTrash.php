...
class VersusDataTableTrash extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('actions', function ($row) {
                $restoreGate      = 'backend.versus.restore';
                $removeGate    = 'backend.versus.remove';
    ...
    {
        return $model->onlyTrashed()->newQuery()->where('type', 3);
    }
