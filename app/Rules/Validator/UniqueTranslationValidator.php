...
class UniqueTranslationValidator
{
    ...
    {
        list ($name, $locale) = $this->getArrayAttributeNameAndLocale($attribute);
     ...
     * @return void
     */
    protected function setMissingErrorMessages(Validator $validator, string $name, string $locale): void
    {
     ...
     * @return bool
     */
    protected function isNovaTranslation(string $attribute): bool
    {
        return !str_contains($attribute, '.') && str_starts_with($attribute, 'translations_');
    }
     ...
     * @return array
     */
    protected function getNovaAttributeNameAndLocale(string $attribute): array
    {
     ...
     * @return bool
     */
    protected function isFilamentTranslation(string $attribute): bool
    {
     ...
     * @return array
     */
    protected function getFilamentAttributeNameAndLocale(string $attribute, $validator): array
    {
     ...
     * @return array
     */
    protected function getArrayAttributeNameAndLocale(string $attribute): array
    {
     ...
     * @return string|null
     */
    protected function getAttributeLocale(string $attribute, string $delimiter): ?string
    {
