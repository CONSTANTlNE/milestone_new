    ...
    <div class="col-span-12 md:col-span-6 xxl:!col-span-4 mt-5">
        <div class="box">
            <div class="box-header">
                <h5 class="box-title">Create a Service</h5>
            </div>
            <div class="box-body">
                        ...
                        <div id="hs-tab-js-behavior-{{$localeindex2}}" class="{{ !$loop->first ? 'hidden' : '' }}"
                            ...
                            <div class="mt-3 flex justify-center">
                                @foreach($locales as $localeindex5 =>$locale5)
                                    @if($locale2==$locale5)
                                        <div id="cardContainer{{$locale5}}" class="w-full"></div>
                                    @endif
                                @endforeach
                            ...
                            <div class="mt-3 flex justify-center">
                                @foreach($locales as $localeindex5 =>$locale5)
                                    @if($locale2==$locale5)
                                        <div id="faqContainer{{$locale5}}" class="w-full"></div>
                                    @endif
                                @endforeach
...
{{--                                                        <label  class="ti-form-label">Answer</label>--}}
                                                        ...
                                                        <textarea form="service_form" name="faq_answer_{{$locale6}}[]" class="ti-form-input" rows="3"
                                                                  placeholder=""></textarea>
                                                    </div>
{{--                                                    <button data-removefaq="0" class="removefaq" style="color:red">--}}
{{--                                                        <i style="font-size: 2rem" class="ri-subtract-line"></i>--}}
{{--                                                    </button>--}}
                                                    <button type="button" class="ti-btn ti-btn-danger-full ti-btn-wave removefaq">Remove Question</button>
                                                </div>
                                            </div>
                                        </template>
                                    @endif
    ...
    <form method="POST" action="{{route('backend.service.store')}}" class="flex justify-center" id="service_form"
        ...
        @endforeach
        <button type="button" id="saveBtn" class="ti-btn ti-btn-primary-full !rounded-full ti-btn-wave">Create Service
        </button>
    </form>
