<div id="edit_features{{$index}}"
    ...
    <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out lg:!max-w-4xl lg:w-full m-3 lg:!mx-auto">
        <div class="ti-modal-content">
            ...
            <form action="" >
                <div class="ti-modal-body" id="editfeatures{{$index}}">

                </div>
                <div class="ti-modal-footer justify-center">
                    <button type="button" class="hs-dropdown-toggle ti-btn  ti-btn-secondary-full align-middle" data-hs-overlay="#edit_features{{$index}}" aria-expanded="true">
                        Close
                    </button>
