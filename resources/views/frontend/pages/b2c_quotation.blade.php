...
@endpush
@section('content')
    <section class="section-md individual_quotation">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-xl-12">
                    <div class="pbmit-heading-subheading individual_quotation-header text-center animation-style2">
            ...
            <div id="index_quotation" class="row">
                <div class="container">
