            ...
            <div class="flex justify-center items-center h-full">
                ...
                <div class="xxl:col-span-6 xl:col-span-6 lg:col-span-6 md:col-span-6 sm:col-span-8 col-span-12">
                    <div class="p-[3rem]">
                        ...
                        @if (Route::currentRouteName() !== 'frontend.auth.register' and feature_enabled_for_customer(Features::registration()))
                        <div class="text-center">
                            <p class="text-[0.75rem] text-[#8c9097] dark:text-white/50 mt-4">{{ __('config.you_have_account') }}
{{--                                გაქვთ თქვენ ექაუნთი?--}}
                                <a href="{{ route('frontend.auth.register') }}" class="text-primary">{{ __('config.register') }}</a></p>
                        </div>
                        @endif
                    </div>
                </div>
