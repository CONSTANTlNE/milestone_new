    ...
    <div class="content">
        ...
        <div class="main-content">
            ...
            <div class="block justify-between page-header md:flex">
                <div
                    class="flex flex-col md:flex-row md:items-center md:justify-center gap-4 w-full align-middle items-center">
                    ...
                    <div class="mt-3 md:mt-0">
                        <form action="{{ route('backend.quotations.index') }}" method="GET"
                            ...
                            @if(request('q') || request('date_from') || request('date_to'))
                                <a href="{{ route('backend.quotations.index') }}"
                                   class="ti-btn ti-btn-outline-secondary">Clear</a>
                            @endif
                        </form>
                    </div>
                    ...
                    <div id="users"
                        ...
                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                            <div class="ti-modal-content" style="background: lightgrey">
                                <form
                                    action="{{route('backend.quotations.notify-users')}}"
                                    method="post">
                                    @csrf
                                    <div class="ti-modal-header">
                                        <h6 class="modal-title text-[1rem] font-semibold">
                                            Send new quotation notification to user
                                        </h6>
                                        <button type="button"
                    ...
                    <div class="justify-between">
                            <div class="box-title box-show-number gap-5">
                                <a href="{{ route('backend.quotations.export') }}"
                                        ...
                                        <tr class="product-list border-b border-primary/10"
                                            ...
                                            <td>
                                                ...
                                                @if(!$quotation->distance_mile)
                                                    <form action="{{route('backend.quotations.calculatedistance')}}"
                                                          method="post">
                                                        @csrf
                                            ...
                                            <td>
                                                ...
                                                @else
                                                    <form action="{{route('backend.quotations.airequest')}}"
                                                          method="post">
                                                        @csrf
                                                        <input type="hidden" name="quotation_id"
                                                               value="{{$quotation->id}}">
                                            ...
                                            <td class="text-center">
                                                <form action="{{route('backend.quotations.calculatecost')}}"
                                                                    ...
                                                                    @foreach($quotation->surcharges as $surcharge_index => $surcharge)
                                                                        <div class="flex gap-2">
                                                                            ...
                                                                            <form
                                                                                ...
                                                                                action="{{route('backend.quotations.update-charge')}}"
                                                                                method="post">
                                                                                @csrf
                                                                                <input type="hidden" name="quotation_id"
                                                                                       value="{{$quotation->id}}">
                                                                            ...
                                                                            <form
                                                                                ...
                                                                                action="{{route('backend.quotations.delete-charge')}}"
                                                                                method="post">
                                                                                @csrf
                                                                                <input type="hidden"
                                                                                       name="surcharge_id"
                                            ...
                                            <td class="text-center">
                                                @if(round($quotation->calculated_cost) != 0)
                                                    ...
                                                    @endif
                                                    <form action="{{route('backend.quotations.sendoffer')}}"
                                                          method="post">
                                                        @csrf
                                                        <input type="hidden" name="quotation_id"
                                                               value="{{$quotation->id}}">
                                                        ...
                                                        <div class="hs-overlay-open:mt-7 ti-modal-box mt-0 ease-out">
                                                            <div class="ti-modal-content">
                                                                ...
                                                                <div class="flex justify-center gap-4">
                                                                    ...
                                                                    <form
                                                                        action="{{route('backend.quotations.delete')}}"
                                                                        method="post">
                                                                        @csrf
