...
@section('title') {{ __('admin.sidebar_serviceCategories') }} @endsection
@section('styles')
    ...
    <div class="content">
        <div class="main-content">
            ...
            <div class="block justify-between page-header md:flex">
                <div>
                    <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.375rem] font-semibold font-first-geo">{{ __('admin.all_serviceCategories') }}</h3>
                            ...
                            <div class="box-title box-show-number gap-5">
                                ...
                                @can('backend.serviceCategories.massDestroy')
                                    <x-backend.table.massDestroy
                                        :url="route('backend.serviceCategories.massDestroy')"
                                    />
                                @endcan
                            </div>
                                    ...
                                    @forelse($serviceCategories as $serviceCategory)
                                        <tr class="product-list border-b border-primary/10" data-id="{{$serviceCategory->id}}">
                                            ...
                                            <td class="flex justify-center">
                                                <x-backend.image :src="$serviceCategory->src" />
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <x-backend.table.status
                                                    ...
                                                    :statusUrl="route('backend.serviceCategories.status')"
                                                />
                                            </td>
                                            <td>
                                                <x-backend.table.actions
                                                    :model="$serviceCategory"
                                                    show-view="backend.serviceCategories.show"
                                                    show-edit="backend.serviceCategories.edit"
                                                    show-delete="backend.serviceCategories.delete"
                                                />
                                            </td>
                                        </tr>
                                    @empty
                                        <tr class="empty-state">
                                            <td colspan="7" class="text-center py-8">
                                                <x-backend.table.empty-state
                                                    :actionText="__('admin.create_first_serviceCategory')"
                                                    permission="backend.serviceCategories.create"
                                                />
                                            </td>
                                        </tr>
                                    @endforelse
