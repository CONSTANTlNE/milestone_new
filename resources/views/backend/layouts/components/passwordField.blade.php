...
<div class="col-md-{{$width}}">
    <div class="form-group position-relative">
        ...
        <input type="password" class="form-control" name="{{$title}}" value="{{$value}}" placeholder="{{ $staticKeyPlaceholder }}" autocomplete="on" @if($required)  id="validationTooltip{{$columnId}}"  required @endif>
