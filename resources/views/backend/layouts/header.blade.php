...
{{--                    <li class="nav-item dropdown notification_dropdown language">--}}
{{--                        <a class="nav-link ai-icon d-flex align-items-center" href="#" role="button" data-toggle="dropdown">--}}
{{--                            <div class="media pr-2">--}}
{{--                                <img src="{{ asset(getLangName(app()->getLocale())->generalImage[0]->src ?? asset(config('filemanager.default_backend_image'))) }}" alt="logo language" title="logo language" width="30">--}}
{{--                            </div>--}}
...
{{--                                                <a href="{{url($locale->code.''.Session::get('langPath'))}}" class="language-link">--}}
{{--                                                    <div class="media">--}}
{{--                                                        <img src="{{ asset($locale->generalImage[0]->src ?? asset(config('filemanager.default_backend_image'))) }}" alt="logo language" width="30">--}}
{{--                                                    </div>--}}
{{--                                                    <div class="media-body pl-2">--}}
{{--                                                        <h6 class="mb-1">{{ $locale->name }}</h6>--}}
{{--                                                    </div>--}}
{{--                                                </a>--}}
{{--                                            </div>--}}
{{--                                        </li>--}}
...
{{--                    @endif--}}
                    ...
                    <li class="nav-item dropdown notification_dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div id="DZ_W_TimeLine02" class="widget-timeline dz-scroll style-1 ps ps--active-y p-3 height470">
                                <ul class="timeline">
                                    <li>
                                        <div class="timeline-badge primary"></div>
                                        <a class="timeline-panel text-muted" href="{{ route('backend.clear-cache', app()->getLocale())}}">
                                            <span>10 წამი მოლოდინი</span>
                                            <h6 class="mb-0">Clear Cache</h6>
                                        </a>
                                    </li>
                                    <li>
                                        <div class="timeline-badge primary"></div>
                                        <a class="timeline-panel text-muted" href="{{ route('backend.clear-route', app()->getLocale())}}">
                                            <span>10 წამი მოლოდინი</span>
                                            <h6 class="mb-0">Clear Route Cache</h6>
                                        </a>
                                    </li>
                                    <li>
                                        <div class="timeline-badge primary"></div>
                                        <a class="timeline-panel text-muted" href="{{ route('backend.clear-view', app()->getLocale())}}">
                                            <span>10 წამი მოლოდინი</span>
                                            <h6 class="mb-0">Clear View Cache</h6>
                                        </a>
                                    </li>
                                    <li>
                                        <div class="timeline-badge danger">
                                        </div>
                                        <a class="timeline-panel text-muted" href="{{ route('backend.cache-route', app()->getLocale())}}">
                                            <span>30წამი მოლოდინი</span>
                                            <h6 class="mb-0">Cache Route</h6>
                                        </a>
                                    </li>
                                    <li>
                                        <div class="timeline-badge danger">
                                        </div>
                                        <a class="timeline-panel text-muted" href="{{ route('backend.cache-config', app()->getLocale())}}">
                                            <span>30წამი მოლოდინი</span>
                                            <h6 class="mb-0">Cache Config</h6>
                                        </a>
                                    </li>
                                    <li>
                                        <div class="timeline-badge info">
                                        </div>
                                        <a class="timeline-panel text-muted" href="{{ route('backend.optimize', app()->getLocale())}}">
                                            <span>30წამი მოლოდინი</span>
                                            <h6 class="mb-0">Re-optimized class loader</h6>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <li class="nav-item dropdown header-profile">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <a href="{{ route('backend.users.edit', [app()->getLocale(), Auth::user()->id]) }}" class="dropdown-item ai-icon">
                                <i class="flaticon-381-user-7"></i>
                                <span class="ml-2">{{ __('strings.Edit') }} </span>
                            </a>
                            @endcan
                            <a class="dropdown-item ai-icon" href="{{ route('backend.logout') }}" aria-expanded="false" onclick="event.preventDefault();
                                     document.getElementById('logout-form').submit();">
                                <i class="flaticon-381-turn-off"></i>
                                <span class="nav-text ml-2">{{ __('strings.Logout') }}</span>
                            </a>
