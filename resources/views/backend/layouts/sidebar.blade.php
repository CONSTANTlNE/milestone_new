    ...
    <div class="main-sidebar" id="sidebar-scroll">
        <nav class="main-menu-container nav nav-pills flex-column sub-open">
            ...
            <ul class="main-menu">
                ...
                <li class="slide">
                    <a href="{{ route('backend.dashboard.analytics') }}" class="side-menu__item font-first-geo">
                ...
                <li class="slide">
                    <a href="{{ route('backend.menus.index') }}" class="side-menu__item font-first-geo">
                ...
                <li class="slide">
                    <a href="{{ route('backend.files.index') }}" class="side-menu__item font-first-geo">
                ...
                <li class="slide">
                    <a href="{{ route('backend.pages.index') }}" class="side-menu__item font-first-geo">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        <li class="slide"><a href="{{ route('backend.articles.index') }}" class="side-menu__item font-second-geo">{{ __('admin.sidebar_all_blogs') }}</a></li>
                        @can('backend.articleCategory.index')
                        <li class="slide"><a href="{{ route('backend.articleCategory.index') }}" class="side-menu__item font-second-geo">{{ __('admin.sidebar_categories_blog') }}</a></li>
                        @endcan
                        @can('backend.articleTags.index')
                        <li class="slide"><a href="{{ route('backend.articleTags.index') }}" class="side-menu__item font-second-geo">{{ __('admin.sidebar_tags_blog') }}</a></li>
                        @endcan
                    </ul>
                </li>
                @endcan
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        <li class="slide"><a href="{{ route('backend.products.index') }}" class="side-menu__item font-second-geo">{{ __('admin.sidebar_all_products') }}</a></li>
                        @can('backend.productCategory.index')
                        <li class="slide"><a href="{{ route('backend.productCategory.index') }}" class="side-menu__item font-second-geo">{{ __('admin.sidebar_categories_product') }}</a></li>
                        @endcan
                        @can('backend.productTags.index')
                        <li class="slide"><a href="{{ route('backend.productTags.index') }}" class="side-menu__item font-second-geo">{{ __('admin.sidebar_tags_product') }}</a></li>
                        @endcan
                        @can('backend.orders.index')
                        <li class="slide"><a href="{{ route('backend.orders.index') }}" class="side-menu__item font-second-geo">{{ __('admin.sidebar_orders') }}</a></li>
                        @endcan
                        @can('backend.payments.index')
                        <li class="slide"><a href="{{ route('backend.payments.index') }}" class="side-menu__item font-second-geo">{{ __('admin.sidebar_payments') }}</a></li>
                        @endcan
                    </ul>
                </li>
                @endcan
                ...
                <li class="slide">
                    <a href="{{ route('backend.sliders.index') }}" class="side-menu__item font-first-geo">
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        ...
                        <li class="slide"><a href="{{ route('backend.customers.index') }}" class="side-menu__item font-second-geo">{{ __('admin.sidebar_customers') }}</a></li>
                        @endcan
                        <li class="slide"><a href="{{ route('backend.users.index') }}" class="side-menu__item font-second-geo">{{ __('admin.sidebar_administrators') }}</a></li>
                        @can('backend.subscribers.index')
                        <li class="slide"><a href="{{ route('backend.subscribers.index') }}" class="side-menu__item font-second-geo">{{ __('admin.sidebar_subscribers') }}</a></li>
                        @endcan
                        @can('backend.roles.index')
                        <li class="slide"><a href="{{ route('backend.roles.index') }}" class="side-menu__item font-second-geo">{{ __('admin.sidebar_roles') }}</a></li>
                        @endcan
                        @can('backend.permissions.index')
                        <li class="slide"><a href="{{ route('backend.permissions.index') }}" class="side-menu__item font-second-geo">{{ __('admin.sidebar_permissions') }}</a></li>
                        @endcan
                    </ul>
                </li>
                @endcan
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        <li class="slide"><a href="{{ route('backend.locales.index') }}" class="side-menu__item font-second-geo">{{ __('admin.sidebar_all_locales') }}</a></li>
                        @can('backend.locales.static')
                        <li class="slide"><a href="{{ route('backend.locales.static.index') }}" class="side-menu__item font-second-geo">{{ __('admin.sidebar_static_words') }}</a></li>
                        @endcan
                    </ul>
                </li>
                @endcan
                ...
                <li class="slide has-sub">
                    ...
                    <ul class="slide-menu child1">
                        <li class="slide"><a href="{{ route('backend.settings.show') }}" class="side-menu__item font-second-geo">{{ __('admin.sidebar_settings') }}</a></li>
                        @can('backend.socials.index')
                        <li class="slide"><a href="{{ route('backend.socials.index') }}" class="side-menu__item font-second-geo">{{ __('admin.sidebar_social_networks') }}</a></li>
                        @endcan
                        @can('backend.backups.index')
                        <li class="slide"><a href="{{ route('backend.backups.index') }}" class="side-menu__item font-second-geo">{{ __('admin.sidebar_backups') }}</a></li>
                        @endcan
                    </ul>
                </li>
                @endcan
