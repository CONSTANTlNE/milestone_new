...
@section('title') {{ __('strings.Edit Data') }} @endsection
@push('styles')
    ...
    <div class="container-fluid">
        <div class="form-head d-md-flex mb-sm-4 mb-3 align-items-start">
            <div class="mr-auto  d-lg-block">
                <h2 class="text-black font-w600">{{ __('strings.Edit Data') }}</h2>
        ...
        <form method="POST" class="needs-validation" action="{{ route('backend.data.update', [app()->getLocale(), $data->id]) }}"  novalidate enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-12 p-0">
                                                    ...
                                                    <div class="tab-content pt-4 pb-0 text-muted no-padding" style="width: 100%">
                                                        <div class="tab-pane active" id="content-locale-{{$lang->code}}" role="tabpanel">
                                                            ...
                                                            <div class="testtest">
                                                                ...
                                                                {{--                                                                    <button type="button" class="btn  btn-primary btn-sm add-slider" id="addSlidertextarea{{$lang->code}}" name="addSlider" data-code="textarea{{$lang->code}}" data-shortcode="slider_images">{{ __('strings.Add Slider Images') }}</button>--}}
                                                                {{--                                                                </div>--}}
                                                                <div class="col-md-12 pb-2">
                    ...
                    <div class="col-md-12 col-xl-3 float-right">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    @include('backend.fileManager.layers.both', ['item' => $data])
                                    <x-select
                                        :lang="null"
                                        :data="null"
                                        column="status"
...
@push('scripts')
    ...
    <script src="{{URL::asset('/js/my/jquery-ui/jquery-ui.min.js')}}"></script>
