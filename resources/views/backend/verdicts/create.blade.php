...
@section('title') {{ __('strings.Verdict Create') }} @endsection
    ...
    <div class="container-fluid">
        <div class="form-head d-md-flex mb-sm-4 mb-3 align-items-start">
            <div class="mr-auto  d-lg-block">
                <h2 class="text-black font-w600">{{ __('strings.Verdict Create') }}</h2>
        ...
        <form method="post" class="needs-validation" action="{{ route('backend.verdicts.store', app()->getLocale()) }}" novalidate enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group position-relative select-access">
                                            <label class="control-label font-w600" for="validationTipSelectstatus">
                                                {{ __('strings.Verdict Percentage') }}:
                                            </label>
                                            <div>
                                                <div id="sliderRange"></div>
                                                <input id="color" name="color" readonly  style="float: left">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div>
                                            ...
                                            <div>
                                                <input type="color" id="color1" name="colorCode" value="#ff0000">
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="form-group position-relative select-access">
                                                ...
                                                <select class="select2 form-control select2" id="validationTipSelectParentId"  name="parent_id" required>
                                                    ...
                                                    @foreach($verdicts as $verdict)
                                                        <option value="{{$verdict->id}}">{{$verdict->getTranslation('title', app()->getLocale())}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
