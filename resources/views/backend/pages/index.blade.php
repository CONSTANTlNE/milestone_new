...
@section('title') {{ __('admin.sidebar_pages') }} @endsection
@section('styles')
    ...
    <div class="content">
        <div class="main-content">
            ...
            <div class="block justify-between page-header md:flex">
                <div>
                    <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.375rem] font-semibold font-first-geo">{{ __('admin.all_pages') }}</h3>
                            ...
                            <div class="box-title box-show-number gap-5">
                                ...
                                @can('backend.pages.massDestroy')
                                    <x-backend.table.massDestroy
                                        :url="route('backend.pages.massDestroy')"
                                    />
                                @endcan
                            </div>
                                    ...
                                    @forelse($pages as $page)
                                        <tr class="product-list border-b border-primary/10" data-id="{{$page->id}}">
                                            ...
                                            <td>
                                                ...
                                                :model="$page"
                                                :statusUrl="route('backend.pages.status')"
                                                />
                                            </td>
                                            <td>
                                                <x-backend.table.actions
                                                    :model="$page"
                                                    show-view="backend.pages.show"
                                                    show-edit="backend.pages.edit"
                                                    show-delete="backend.pages.delete"
                                                />
                                            </td>
                                        </tr>
                                    @empty
