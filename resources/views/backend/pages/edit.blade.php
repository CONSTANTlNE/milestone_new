...
@section('title') {{ __('strings.Edit Page') }} @endsection
@push('styles')
    ...
    <div class="container-fluid">
        <div class="form-head d-md-flex mb-sm-4 mb-3 align-items-start">
            <div class="mr-auto  d-lg-block">
                <h2 class="text-black font-w600">{{ __('strings.Edit Page') }}</h2>
        ...
        <form method="post" class="needs-validation" action="{{ route('backend.pages.update', [app()->getLocale(), $page->id]) }}"  novalidate enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
