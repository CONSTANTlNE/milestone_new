...
@section('title') {{ __('admin.deleted_sliders') }} @endsection
@section('styles')
    ...
    <div class="content">
        <div class="main-content">
            ...
            <div class="block justify-between page-header md:flex">
                <div>
                    <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.375rem] font-semibold font-first-geo">{{ __('admin.deleted_sliders') }}</h3>
                    ...
                    <div class="box custom-box">
                        <div class="box-header justify-between">
                            <div class="box-title box-show-number gap-5">
                                ...
                                @can('backend.sliders.massRemove')
                                    <x-backend.table.massRemove
                                        :url="route('backend.sliders.massRemove')"
                                    />
                                @endcan
                            </div>
                                        ...
                                        <tr class="product-list border-b border-primary/10" data-id="{{$slider->id}}">
                                            ...
                                            <td>
                                                <x-backend.table.actions
                                                    :model="$slider"
                                                    show-remove="backend.sliders.remove"
                                                    show-restore="backend.sliders.restore"
                                                />
                                            </td>
                                        </tr>
                                    @empty
                                        <tr class="empty-state">
                                            <td colspan="7" class="text-center py-8">
                                                <x-backend.table.empty-state
                                                    :actionText="__('admin.all_sliders')"
                                                    :trash="true"
                                                    permission="backend.sliders.index"
                                                />
                                            </td>
                                        </tr>
                                    @endforelse
