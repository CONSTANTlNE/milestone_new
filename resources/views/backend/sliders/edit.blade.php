...
@section('title') {{ __('admin.edit_sliders') }} @endsection
@section('styles')
    ...
    <div class="content">
        <div class="main-content">
            ...
            <div class="block justify-between page-header md:flex">
                <div>
                    <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.375rem] font-semibold font-first-geo">{{ __('admin.edit_sliders') }}</h3>
            ...
            <form method="post" action="{{ route('backend.sliders.update', $slider->id) }}" novalidate enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-12 gap-6 white-bg">
                    ...
                    <div class="xl:col-span-3 col-span-12">
                        <div class="box">
                            <div class="box-body">
                                @include('backend.fileManager.layers.both', ['item' => $slider])

                                <x-backend.publishDate
                                    :data="$slider->created_at"
                                    column="published_at"
                                    label="published_at"
                                    place-holder=""
