...
@section('title') {{ __('strings.edit_faqs') }} @endsection
@section('styles')
    ...
    <div class="content">
        <div class="main-content">
            ...
            <div class="block justify-between page-header md:flex">
                <div>
                    <h3 class="!text-defaulttextcolor dark:!text-defaulttextcolor/70 dark:text-white dark:hover:text-white text-[1.375rem] font-semibold font-first-geo">{{ __('admin.edit_faqs') }}</h3>
            ...
            <form method="post" action="{{ route('backend.faqs.update', $faq->id) }}" novalidate enctype="multipart/form-data">
                @csrf
                @method('PUT')
