...
@section('title') {{ __('strings.Edit Article') }} @endsection
@push('styles')
    ...
    <div class="container-fluid">
        <div class="form-head d-md-flex mb-sm-4 mb-3 align-items-start">
            <div class="mr-auto  d-lg-block">
                <h2 class="text-black font-w600">{{ __('strings.Edit Article') }}</h2>
        ...
        <form method="post" class="needs-validation" action="{{ route('backend.articles.update', [app()->getLocale(), $article->id]) }}"  novalidate enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                    ...
                    <div class="form-group position-relative select-access">
                        ...
                        <select id="validationTipSelectVerdict" class="select2 form-control select2 dropdown-groups" name="verdict" required>
                            @if(isset($article->verdict))
                                ...
                                <option value="0">{{ __('strings.Delete the assigned Verdict') }}</option>
                            @else
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group position-relative select-access">
                                            ...
                                            $options = [
                                                ...
                                                '5' => 'Show on Main Page',
                                                '6' => 'User provided facts',
                                                '7' => 'FB Instant Article'
                                            ]
                                            @endphp
                                            ...
                                            <select id="validationTipSelectType" class="select2 form-control select2 multi-select" name="options[]" multiple="multiple" required>
                                                ...
                                                <option value="7">FB Instant Article</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="datetime-local" name="published_at" class="datepicker-default form-control" id="datetimepicker" value="{{$article->created_at}}">
                                    </div>
                                        ...
                                        <div class="form-group position-relative select-access">
                                            ...
                                            <select id="validationTipSelectRegion" class="select2 form-control select2 dropdown-groups" name="region" required>
                                                @if(count($article->regions))
                                                    ...
                                                    <option value="0">{{ __('strings.Delete the assigned Region') }}</option>
                                                @else
