...
@section('title') {{ __('strings.Edit Team') }} @endsection
@push('styles')
    ...
    <div class="container-fluid">
        <div class="form-head d-md-flex mb-sm-4 mb-3 align-items-start">
            <div class="mr-auto  d-lg-block">
                <h2 class="text-black font-w600">{{ __('strings.Edit Team') }}</h2>
        ...
        <form method="POST" class="needs-validation" action="{{ route('backend.teams.update', [app()->getLocale(), $team->id]) }}"  novalidate enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-md-12 p-0">
                    ...
                    <div class="col-md-12 col-xl-3 float-right">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    @include('backend.fileManager.layers.both', ['item' => $team])
                                    <x-select
                                        :lang="null"
                                        :data="null"
                                        column="status"
