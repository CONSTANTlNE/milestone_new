...
@section('title') {{ __('admin.edit_social_network') }} @endsection
@section('content')
    <div class="content">
        <div class="main-content">
            ...
            <form method="post" action="{{ route('backend.socials.update',  $social->id) }}" novalidate enctype="multipart/form-data">
                @csrf
                @method('PUT')
