...
@section('title') {{ __('admin.edit_role') }} @endsection
@section('content')
    <div class="content">
        <div class="main-content">
            ...
            <form method="post" action="{{ route('backend.roles.update',  $role->id) }}" novalidate enctype="multipart/form-data">
                @csrf
                @method('PUT')
                                                ...
                                                @foreach($permissions as $permission)
                                                    @if(in_array($permission->id, $rolePermissions))
                                                        <div class="form-check">
                                                            <input class="form-check-input permission-checkbox permission-checkbox-{{ $group }}" type="checkbox" checked name="permission[]" value="{{ $permission->id }}" id="checkebox-{{$permission->id}}">
                        ...
                        <div class="box">
                            <div class="box-body">
                                ...
                                <x-backend.selectStatic
                                    ...
                                    :choose="$role->has_backend_access"
