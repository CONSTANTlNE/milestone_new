...
@section('title') {{ __('strings.Region Create') }} @endsection
@push('styles')
    ...
    <div class="container-fluid">
        <div class="form-head d-md-flex mb-sm-4 mb-3 align-items-start">
            <div class="mr-auto  d-lg-block">
                <h2 class="text-black font-w600">{{ __('strings.Region Create') }}</h2>
        ...
        <form method="post" class="needs-validation" action="{{ route('backend.regions.store', app()->getLocale()) }}" novalidate enctype="multipart/form-data">
            {{csrf_field()}}
            <div class="row">
